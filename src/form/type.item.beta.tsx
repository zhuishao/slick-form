...
export type FieldPropsByType<T extends FormFiledItemType> =
  T extends 'AutoComplete'
    ? { type: T; props?: AutoCompleteProps }
    : T extends 'Input'
    ? { type: T; props?: InputProps }
    : T extends 'InputNumber'
    ? { type: T; props?: InputNumberProps }
    : T extends 'Rate'
    ? { type: T; props?: RateProps }
    : T extends 'Slider'
    ? { type: T; props?: SliderSingleProps }
    : T extends 'TextArea'
    ? { type: T; props?: TextAreaProps }
    : T extends 'Password'
    ? { type: T; props?: PasswordProps }
    : T extends 'Select'
    ? {
        type: T;
        props?: SelectProps<any> & { autoFilterRepeatValue?: boolean };
      }
    : T extends 'RadioGroup'
    ? { type: T; props?: RadioGroupProps }
    : T extends 'CheckGroup'
    ? { type: T; props?: CheckboxProps }
    : T extends 'DatePicker'
    ? { type: T; props?: DatePickerProps }
    : T extends 'TimePicker'
    ? { type: T; props?: TimePickerProps }
    : T extends 'TimeRange'
    ? { type: T; props?: TimeRangePickerProps }
    : T extends 'RangePicker'
    ? { type: T; props?: DatePickerProps }
    : T extends 'TreeSelect'
    ? { type: T; props?: TreeSelectProps<any> }
    : T extends 'Cascader'
    ? { type: T; props?: CascaderProps<any> }
    : T extends 'Upload'
    ? { type: T; props?: UploadProps }
    : T extends 'Switch'
    ? { type: T; props?: SwitchProps }
    : T extends 'AsyncSelect'
    ? { type: T; props?: FieldProps }
    ...
    ? { type: T; props?: OssFileUploadProps }
    : T extends String
    ? { type: T; props?: FieldProps }
    : T extends Function
    ? { type: T; props?: FieldProps }
...
export type FormFieldProps<P = {}> = CommonProps & { props?: P } & (
    | FieldPropsByType<'AutoComplete'>
    | FieldPropsByType<'Input'>
    | FieldPropsByType<'InputNumber'>
    | FieldPropsByType<'Rate'>
    | FieldPropsByType<'Slider'>
    | FieldPropsByType<'TextArea'>
    | FieldPropsByType<'Password'>
    | FieldPropsByType<'Select'>
    | FieldPropsByType<'RadioGroup'>
    | FieldPropsByType<'CheckGroup'>
    | FieldPropsByType<'DatePicker'>
    | FieldPropsByType<'TimePicker'>
    | FieldPropsByType<'TimeRange'>
    | FieldPropsByType<'RangePicker'>
    | FieldPropsByType<'TreeSelect'>
    | FieldPropsByType<'Cascader'>
    | FieldPropsByType<'Upload'>
    | FieldPropsByType<'Switch'>
    | FieldPropsByType<'AsyncSelect'>
    | FieldPropsByType<'AsyncTreeSelect'>
    | FieldPropsByType<'DebounceSelect'>
    | FieldPropsByType<'AsyncCascader'>
    | FieldPropsByType<'AsyncCheckGroup'>
    | FieldPropsByType<'AsyncRadioGroup'>
    | FieldPropsByType<'Render'>
    | FieldPropsByType<'AsyncRender'>
    | FieldPropsByType<'FormList'>
    | FieldPropsByType<'BlockQuote'>
    | FieldPropsByType<'FieldSet'>
    | FieldPropsByType<'UploadImage'>
    | FieldPropsByType<'CountInput'>
    | FieldPropsByType<'BankCardInput'>
    | FieldPropsByType<'AmountInput'>
    | FieldPropsByType<'EditableTable'>
    | FieldPropsByType<'RichEditor'>
    | FieldPropsByType<'PcaSelect'>
    | FieldPropsByType<'AddressLinkMap'>
    | FieldPropsByType<'OssFileUpload'>
  );
