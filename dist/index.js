...
var icons$1 = require('@ant-design/icons/es/icons');
...
var AnchorCard = (function (_ref) {
  ...
  var ticking = false;
  var _useState = React.useState(defaultActivityKey),
...
var staticThemeMethodHooks = (function () {
  ...
  var staticFunction = antd.App.useApp();
  message = (staticFunction === null || staticFunction === void 0 ? void 0 : (_staticFunction$messa = staticFunction.message) === null || _staticFunction$messa === void 0 ? void 0 : _staticFunction$messa.destroy) ? staticFunction.message : antd.message;
  modal = staticFunction.modal.confirm ? staticFunction.modal : antd.Modal;
  notification = staticFunction.notification.open ? staticFunction.notification : antd.notification;
  return {
    message: message,
...
var cloneDeep = function cloneDeep(source) {
  return lodash.cloneDeepWith(source, function (target) {
...
var CreateModalForm = function CreateModalForm(props) {
  ...
  ReactDOM.render(React__default.createElement(antd.ConfigProvider, {
    theme: {
      token: token
    }
...
var authName = Symbol('');
var ProButton = React.forwardRef(function (_ref, ref) {
  var spin = _ref.spin,
  ...
  var vNode = React__default.createElement(antd.Button, Object.assign({
    loading: loading
  }, props, {
  ...
  if (isPopConfirm) {
    vNode = React__default.createElement(antd.Popconfirm, Object.assign({
      onConfirm: onClick,
      okText: "\u786E\u5B9A",
      cancelText: "\u53D6\u6D88"
    }, confirm, {
  ...
  if (tooltip) {
    ...
    vNode = React__default.createElement(antd.Tooltip, Object.assign({}, tooltipProps), vNode);
  }
...
var SpinComponent = function SpinComponent(_ref) {
  ...
  return mode === 'loading' ? React__default.createElement(antd.Spin, Object.assign({
    spinning: true
...
function CopyLabelContent(_ref) {
  ...
  var sumIconStyle = React.useMemo(function () {
  ...
  }, ellipsis && ((content === null || content === void 0 ? void 0 : content.length) || 0) > 14 ? React__default.createElement(antd.Tooltip, {
    title: content
  ...
  }, copyTxt ? React__default.createElement(icons.CopyOutlined, null) : React__default.createElement(antd.Tooltip, {
    placement: "top",
    title: "\u590D\u5236"
  }, React__default.createElement(icons.CopyOutlined, null)), copyTxt), copyable && copied && React__default.createElement("div", {
    style: sumIconStyle,
    className: "copy-icon cd"
  }, copyTxt ? React__default.createElement(icons.CheckOutlined, null) : React__default.createElement(antd.Tooltip, {
    placement: "top",
    title: "\u590D\u5236\u6210\u529F",
    open: showCopied
  }, React__default.createElement(icons.CheckOutlined, null)), copyTxt));
}
...
var PreviewFile = (function (_ref) {
  ...
  }, React__default.createElement(icons$1.EyeOutlined, {
    style: {
...
var CustomRender = function CustomRender(_ref) {
  ...
  }, React__default.createElement(icons$1.DeleteOutlined, null))) : React__default.createElement("div", {
  ...
  }, React__default.createElement(icons$1.DeleteOutlined, null))));
};
...
var OssFileUpload = (function (_ref) {
  ...
  var beforeUpload = function beforeUpload(file) {
    try {
      ...
      if (!accept.split(',').map(function (item) {
        ...
        antd.message.error(file.name + " \u6587\u4EF6\u683C\u5F0F\u4E0D\u5728" + accept + "\u4E2D");
        return antd.Upload.LIST_IGNORE;
      }
      var size = file.size;
      var isLtSize = size / 1024 / 1024 <= limitSize;
      if (!isLtSize) {
        antd.message.error("\u6587\u4EF6\u5927\u5C0F\u4E0D\u5141\u8BB8\u8D85\u8FC7" + limitSize + "M");
        return antd.Upload.LIST_IGNORE;
      }
      return isLtSize;
    } catch (error) {
  ...
  var moveRow = React.useCallback(function (dragIndex, hoverIndex) {
    var dragRow = value[dragIndex];
    onChange(update(value, {
      $splice: [[dragIndex, 1], [hoverIndex, 0, dragRow]]
    }));
  }, [value]);
  var uploadButton = listType === 'picture-card' ? React__default.createElement("div", null, loading ? React__default.createElement(icons.LoadingOutlined, null) : React__default.createElement(icons.PlusOutlined, null), React__default.createElement("div", {
    style: {
      marginTop: 8
    }
  }, text)) : React__default.createElement("div", null, React__default.createElement(antd.Button, {
    loading: loading,
  ...
  }, React__default.createElement(antd.Upload, Object.assign({}, props, {
    maxCount: maxCount,
    accept: accept,
    showUploadList: {
...
var DescList = function DescList(_ref) {
  ...
  return React__default.createElement(Warp, Object.assign({
    width: 500,
    title: "\u8BE6\u60C5",
    extra: React__default.createElement(antd.Space, null, React__default.createElement(antd.Button, {
      type: "primary"
    }, "\u5237\u65B0"), React__default.createElement(antd.Button, null, "\u7F16\u8F91"))
  }, drawerProps, {
    visible: visible,
    onClose: onClose
  }), type === 'Card' && React__default.createElement("div", {
    className: 'operation-area'
  }, React__default.createElement("h3", null, "\u8BE6\u60C5"), React__default.createElement(antd.Space, null, React__default.createElement(antd.Button, {
    type: "primary",
    onClick: onRefresh
  }, "\u5237\u65B0"), React__default.createElement(antd.Button, null, "\u7F16\u8F91"))), React__default.createElement(antd.Row, {
    gutter: gutter,
  ...
  if (!children) {
    ...
    children = dataSource === null || dataSource === void 0 ? void 0 : (_dataSource$filter = dataSource.filter(function (item) {
      ...
      return React__default.createElement(DescriptionsItem, {
        label: (item === null || item === void 0 ? void 0 : item.tooltip) ? React__default.createElement("span", null, item.label, React__default.createElement(antd.Tooltip, {
          title: item.tooltip
        }, React__default.createElement(icons.QuestionCircleOutlined, {
          style: {
            marginLeft: 2
          }
        }))) : item.label,
...
var SortContainer = reactSortableHoc.SortableContainer(function (props) {
...
var DragList = (function (_ref) {
  ...
  var _useState = React.useState(defaultActiveKey),
    activeKey = _useState[0],
    setActiveKey = _useState[1];
  var _useState2 = React.useState([].concat(list)),
  ...
  var onSortEnd = function onSortEnd(_ref2) {
    ...
    if (oldIndex !== newIndex) {
      var newData = reactSortableHoc.arrayMove([].concat(innerList), oldIndex, newIndex);
  ...
  return React__default.createElement("div", {
    ...
    return React__default.createElement(SortableItem, {
      ...
      key: i.key,
      value: i
    }, React__default.createElement(antd.Space, null, showIcon && React__default.createElement(DragHandle, null), React__default.createElement("div", {
...
var DraggableTabNode = function DraggableTabNode(_ref) {
  ...
  var _useContext = React.useContext(TabOrderContext),
...
var DraggableTabs = function DraggableTabs(props) {
  ...
  var _useState3 = React.useState(items.map(function (item) {
      return item.key;
    })),
    order = _useState3[0],
    setOrder = _useState3[1];
  var _useState4 = React.useState(items === null || items === void 0 ? void 0 : (_items$ = items[0]) === null || _items$ === void 0 ? void 0 : _items$.key),
  ...
  }, React__default.createElement(antd.Tabs, Object.assign({
    hideAdd: true,
...
var CheckGroupAll = (function (_ref) {
  ...
  return React__default.createElement(antd.Space, {
    direction: "vertical"
  }, React__default.createElement("div", {
    ...
    checked: isCheckAll
  }, typeof showCheckAll === 'object' ? showCheckAll.text || '全选' : '全选')), React__default.createElement(antd.Checkbox.Group, Object.assign({}, props, {
    onChange: onChange
  })));
});
...
var CheckGroup = function CheckGroup(_ref) {
  ...
  })) : React__default.createElement(antd.Checkbox.Group, Object.assign({}, props));
};
...
var AsyncComponent = (function (Component) {
  return function (_ref) {
    ...
    return Component.displayName === 'Select' ? React__default.createElement(Component, Object.assign({}, props, {
      ...
      notFoundContent: loading ? React__default.createElement(antd.Spin, {
        size: "small"
      ...
      options: options
    })) : !props.readOnly && React__default.createElement(antd.Empty, {
      image: antd.Empty.PRESENTED_IMAGE_SIMPLE,
      description: emptyDescription
    });
  };
...
var RadioGroup = function RadioGroup(_ref) {
  ...
  return React__default.createElement(antd.Radio.Group, Object.assign({}, props));
};
...
var AsyncRender = (function (props) {
  ...
  var asyncJsx = React.useMemo(function () {
  ...
  var Spin = React.useMemo(function () {
...
var __Select__ = function __Select__(_ref) {
  ...
  return React__default.createElement(antd.Select, Object.assign({}, props, {
...
var DateTimeHabit = (function (_ref) {
  ...
  var _useState = React.useState(value.date),
    date = _useState[0],
    setDate = _useState[1];
  var _useState2 = React.useState(value.time),
    time = _useState2[0],
  ...
  return React__default.createElement(antd.Space, null, React__default.createElement(antd.DatePicker, {
...
var DebounceSelect = function DebounceSelect(_ref) {
  ...
  var optionsCacheRef = React.useRef();
  var init = function init() {
    try {
      return Promise.resolve(_finallyRethrows(function () {
        return _catch(function () {
...
var FieldSet = function FieldSet(_ref) {
  var _ref$style = _ref.style,
    style = _ref$style === void 0 ? {} : _ref$style,
    _ref$children = _ref.children,
    children = _ref$children === void 0 ? React__default.createElement(antd.Empty, {
      image: antd.Empty.PRESENTED_IMAGE_SIMPLE
    }) : _ref$children,
    _ref$label = _ref.label,
  ...
  }, React__default.createElement(antd.Space, null, extra === null || extra === void 0 ? void 0 : extra.map(function (dom) {
    return dom;
  })))), React__default.createElement("div", {
...
var Item = (function (_ref) {
  ...
  var _useState = React.useState(field),
  ...
  var _field = React.useMemo(function () {
    return cloneDeep(innerField);
  }, [innerField]);
  var mergeField = React.useCallback(function (newField, customizer) {
    setInnerField(_extends({}, mergeWith(innerField, newField, customizer)));
    setReload(Math.random());
  }, []);
  var _useState2 = React.useState(Math.random()),
    reload = _useState2[0],
    setReload = _useState2[1];
  var touchEffect = React.useCallback(function (item, triggerField) {
  ...
  var FormItem = React__default.createElement(antd.Form.Item, Object.assign({}, pureFields, {
    key: reload,
    itemID: itemID,
...
var FormList = (function (_ref) {
  ...
  return React__default.createElement(antd.Form.List, {
    name: name
  }, function (f, _ref2) {
    var _add = _ref2.add,
    ...
    actionRef.current[name] = {
      add: function () {
        try {
          if (notOperation) {
            return Promise.resolve(antd.message.info('不可操作'));
          }
          if ((f === null || f === void 0 ? void 0 : f.length) === maxCount) {
            return Promise.resolve(antd.message.info("\u6700\u591A\u53EA\u80FD\u6DFB\u52A0" + maxCount + "\u6761"));
          }
      ...
      remove: function (idx) {
        ...
        try {
          ...
          if (leastOne && f.length === 1) {
            return Promise.resolve(antd.message.info('至少保留一条'));
          }
          _remove(idx);
          return Promise.resolve();
        } catch (e) {
    ...
    return React__default.createElement(React__default.Fragment, null, f.map(function (item, index, _ref3) {
      ...
      }, label, index + 1), !notOperation && React__default.createElement(antd.Button, {
        type: "link",
    ...
    }), notOperation && f.length === 0 && React__default.createElement(antd.Empty, {
      image: antd.Empty.PRESENTED_IMAGE_SIMPLE
    }), !notOperation && React__default.createElement(antd.Form.Item, null, React__default.createElement(antd.Button, {
      type: "dashed",
          ...
          setTimeout(function () {
            try {
              return Promise.resolve(navigator.clipboard.writeText(text)).then(function () {
                showNotice && antd.message.success('已复制到剪切板');
              });
            } catch (e) {
              return Promise.reject(e);
            }
...
var __InputNumber__ = function __InputNumber__(_ref) {
  ...
  if (autoValidInputNumber) {
    return React__default.createElement(antd.InputNumber, Object.assign({}, restProps, {
      maxLength: 15
    }));
  }
...
var UploadImage = (function (props) {
  ...
  var beforeUpload = function beforeUpload(file) {
    try {
      ...
      var size = file.size;
      var isLtSize = size / 1024 / 1024 <= limitSize;
      if (!isLtSize) antd.message.error("\u6587\u4EF6\u5927\u5C0F\u4E0D\u5141\u8BB8\u8D85\u8FC7" + limitSize + "M");
      return isLtSize;
    } catch (error) {
      console.log(error);
    }
  ...
  var _fileList = Array.isArray(fileList) ? fileList : JSON.parse(JSON.stringify(fileList.fileList || []));
  return React__default.createElement(React__default.Fragment, null, React__default.createElement(antd.Upload, Object.assign({}, props, {
    fileList: _fileList,
    beforeUpload: beforeUpload,
    onChange: onChange,
    onRemove: onRemove,
...
var __AutoComplete__ = function __AutoComplete__(_ref) {
  ...
  return React__default.createElement(antd.AutoComplete, Object.assign({}, props));
};
...
var Password = function Password(_ref) {
  ...
  return React__default.createElement(antd.Input.Password, Object.assign({}, props));
};
...
var SplitRangerPicker = function SplitRangerPicker(_ref) {
  ...
  var _useState2 = React.useState(props),
  ...
  var renderExtraFooter = function renderExtraFooter() {
    return React__default.createElement("span", null, "\u5FEB\u901F\u9009\u62E9\u7ED3\u675F\u65F6\u95F4\uFF1A", React__default.createElement(antd.Space, {
  ...
  }, React__default.createElement(antd.Space, null, React__default.createElement(antd.DatePicker, Object.assign({
    value: innerValue[0]
  }, props, {
    onChange: function onChange(v) {
      onInnerChange(v, innerValue[1], 'start');
    }
  })), React__default.createElement(antd.DatePicker, Object.assign({
    value: innerValue[1]
  }, props, endProps, {
    onChange: function onChange(v) {
...
var TextArea = function TextArea(_ref) {
  ...
  if (autoShowFormTextAreaCount) {
    ...
    }, React__default.createElement(antd.Input.TextArea, Object.assign({}, restProps)), !(props === null || props === void 0 ? void 0 : props.isSearchForm) && React__default.createElement("div", {
      style: {
        position: 'absolute',
        right: 0
      }
  ...
  return React__default.createElement(antd.Input.TextArea, Object.assign({}, props));
};
...
var TimeRange = function TimeRange(_ref) {
  ...
  return React__default.createElement(antd.TimePicker.RangePicker, Object.assign({}, props));
};
...
var __Upload__ = function __Upload__(_ref) {
  ...
  return React__default.createElement(antd.Upload, Object.assign({}, props));
};
...
var Form = (function (_ref) {
  ...
  var _useState = React.useState(false),
    spin = _useState[0],
    setSpin = _useState[1];
  var cloneFields = React.useMemo(function () {
  ...
  var RenderFields = React.useCallback(function (_ref3) {
  ...
  }, rest), React__default.createElement(antd.Spin, {
    spinning: spin,
...
var FormLib = function FormLib(formProps) {
  ...
  var _useState = React.useState(Math.random()),
    reload = _useState[0],
    setReload = _useState[1];
  var _useState2 = React.useState(props.initialValues),
...
var Footer = (function (_ref) {
  ...
  var _useState2 = React.useState(actions),
  ...
  return React__default.createElement(antd.Space, null, innerActions.filter(function (i) {
...
var CardForm = (function (_ref) {
  ...
  }, React__default.createElement(antd.Card, Object.assign({}, cardProps, {
    title: title,
...
var DrawerForm = (function (props) {
  ...
  var _useState = React.useState(rest.initialValues),
    value = _useState[0],
  ...
  return React__default.createElement(antd.Drawer, Object.assign({}, _extends({
    getContainer: false
  }, drawerProps), {
    className: _className.join(' '),
    width: width,
...
var ModalForm = (function (_ref) {
  ...
  var draggleRef = React.useRef(null);
  var _useState2 = React.useState(false),
  ...
  return React__default.createElement(antd.Modal, Object.assign({}, _extends({
    getContainer: false
  }, modalProps), {
    className: _className.join(' '),
    width: width,
...
var step = (function (_ref) {
  ...
  }, React__default.createElement(antd.Steps, Object.assign({}, stepProps, {
    current: current,
    onChange: onStepsClick
  }), steps === null || steps === void 0 ? void 0 : steps.map(function (step) {
    return React__default.createElement(antd.Steps.Step, {
      title: step.title,
...
var useSpin = (function (props) {
  ...
  var _useState = React.useState(props.spinning || false),
    spin = _useState[0],
    setSpin = _useState[1];
  var SpinContainer = function SpinContainer(_ref) {
    var children = _ref.children;
    return React__default.createElement(antd.Spin, Object.assign({}, props, {
      spinning: spin
    }), children);
  };
  return {
...
var notify = function notify(description, type) {
  ...
  antd.notification === null || antd.notification === void 0 ? void 0 : antd.notification[type]({
    message: '提示',
...
var index$2 = (function (_ref) {
  ...
  var success = React.useCallback(function (description) {
    antd.notification.success({
      message: '提示',
      description: description
    });
  }, []);
  var _Layers = React.useMemo(function () {
    var allLayer = {};
...
function Tips(_ref) {
  ...
  var _useState = React.useState('top-left'),
    imgDire = _useState[0],
  ...
  var onResize = React.useCallback(lodash.debounce(setTipsPosition, 300), []);
  React.useEffect(function () {
    setTipsPosition();
  ...
  return React__default.createElement("div", {
    ...
    id: "__step__jump",
    onClick: lodash.debounce(ending, 200),
    style: {
      flex: '1 1 0%',
      cursor: 'pointer'
    }
    ...
    onClick: lodash.debounce(function () {
      switchSteps('proviousStep');
    }, 200)
  }, step > 1 ? "" + (previousText || '上一步') : ''), React__default.createElement(antd.Button, {
    type: "primary",
    onClick: lodash.debounce(switchSteps, 200)
...
var Dialog = function Dialog(_ref) {
  ...
  var onResize = React.useCallback(lodash.debounce(createdAndUpdateBoxChild, 300), []);
  React.useEffect(function () {
    window.addEventListener('resize', onResize);
    return function () {
      overflow = '';
...
var OperationArea = (function (_ref) {
  ...
  return React__default.createElement("div", {
    className: 'operation-area'
  }, !hideReload && React__default.createElement(antd.Button, {
    className: 'color-6e',
  ...
  }), operations.length > moreCount && React__default.createElement(antd.Dropdown, {
    overlayClassName: 'drop-down',
    trigger: ['click'],
    overlay: React__default.createElement(antd.Menu, null, operations.slice(moreCount).map(function (i) {
...
var index$4 = React.forwardRef(function (_ref, ref) {
  var tabs = _ref.tabs,
  ...
  var _useState = React.useState(!!initOpen || defaultOpen),
    visible = _useState[0],
    setVisible = _useState[1];
  var _useState2 = React.useState(initOpen != null ? initOpen : ''),
  ...
  var renderItem = function renderItem(_ref2) {
    ...
    return React__default.createElement(antd.Menu.Item, Object.assign({}, props), label);
  };
...
var Search = (function (_ref) {
  ...
  var _useState = React.useState(defaultExpand),
    more = _useState[0],
    setMore = _useState[1];
  ...
  var moreLabel = React.useMemo(function () {
  ...
  var searchBtn = React__default.createElement("div", {
    ...
    return React__default.createElement(antd.Button, Object.assign({}, tool, {
...
var transformColumns = function transformColumns(_ref) {
  ...
  if (Array.isArray(columns)) {
    return newColumns.map(function (column) {
      ...
      if (column.tip) {
        column.title = React__default.createElement(antd.Space, null, column.title, React__default.createElement(antd.Tooltip, {
          placement: "top",
          title: column.tip
        }, React__default.createElement("i", {
      ...
      column.render = function (item, record, index) {
        ...
        if (column.ellipsis) {
          vNode = React__default.createElement(antd.Tooltip, Object.assign({
            placement: "topLeft",
            title: vNode
          }, column.tooltipProps), vNode);
        }
        if (column.copyable) {
          vNode = React__default.createElement(antd.Space, null, vNode, React__default.createElement(antd.Typography.Paragraph, {
        ...
        if (column.suffix) {
          vNode = React__default.createElement(React.Fragment, null, vNode, column.suffix);
        }
        return vNode;
      };
      return column;
...
var _onSortEnd = function onSortEnd(_ref) {
  ...
  if (oldIndex !== newIndex) {
    var newData = reactSortableHoc.arrayMove(dataSource.slice(), oldIndex, newIndex).filter(function (el) {
      return !!el;
    });
...
var getRowOperations = (function (_ref) {
  ...
  var RenderItem = function RenderItem(_ref2) {
    ...
    }), menu.copyable ? React__default.createElement(antd.Typography.Paragraph, {
  ...
  return rowOperations.visible === false ? null : _extends({}, rowOperations, {
    ...
    render: function render(_, record, index) {
      ...
      }), menus.length > rowOperations.showMore && React__default.createElement(antd.Dropdown, {
        arrow: true,
        overlay: React__default.createElement(antd.Menu, {
...
var FilterColumns = (function (_ref) {
  ...
  var columnList = React.useMemo(function () {
...
var ToolBar = (function (props) {
  ...
  var renderTool = function renderTool(tool) {
    ...
    switch (tool.type) {
      ...
      case 'Dropdown':
        return ((_tool$menu = tool.menu) === null || _tool$menu === void 0 ? void 0 : _tool$menu.length) > 0 ? React__default.createElement(antd.Dropdown, {
          ...
          overlay: React__default.createElement(antd.Menu, {
            ...
            if (item.type === 'Divider') {
              return React__default.createElement(antd.Menu.Divider, {
                key: item.key || index
              });
            }
            return React__default.createElement(antd.Menu.Item, {
  ...
  }, React__default.createElement(antd.Space, null, _tools.map(function (tool) {
...
var VirtualTable = (function (_ref) {
  ...
  var renderVirtualList = function renderVirtualList(rawData, _ref3) {
    ...
    return React__default.createElement("div", {
      ...
      tip: "\u52A0\u8F7D\u4E2D"
    })) : null, React__default.createElement(reactWindow.VariableSizeGrid, {
      ref: gridRef,
  ...
  }, React__default.createElement("div", null, React__default.createElement(antd.Table, {
    rowKey: rowKey,
...
var Table = (function (_ref) {
  ...
  var _useState2 = React.useState(filterIds),
  ...
  var filterRef = React.useRef(undefined);
  var sorterRef = React.useRef(undefined);
  ...
  var _useState3 = React.useState((rowSelection === null || rowSelection === void 0 ? void 0 : rowSelection.defaultSelectedRows) || []),
  ...
  return virtual ? React__default.createElement("div", {
    ...
    className: "shine-table-form",
    style: style
  }, ToolBarNode, React__default.createElement(antd.Table, Object.assign({
    rowKey: rowKey,
    dataSource: ctx.dataSource,
    columns: newColumns,
    loading: ctx.loading,
...
var useGetContext = function useGetContext(_ref) {
  ...
  var _useState3 = React.useState([]),
    dataSource = _useState3[0],
    setDataSource = _useState3[1];
  var _useState4 = React.useState(_extends({}, defaultPaginationConfig, paginationConfig)),
    pagination = _useState4[0],
    setPagination = _useState4[1];
  var _useState5 = React.useState(_extends({
...
var TableProvider = React.forwardRef(Container);
...
exports.AnchorCard = AnchorCard;
exports.AnchorCardForm = index$6;
exports.Button = ProButton;
exports.CardForm = CardForm;
exports.CopyLabelContent = CopyLabelContent;
exports.CreateForm = CreateForm;
exports.CreateSpin = index;
...
exports.StaticThemeMethod = staticThemeMethodHooks;
exports.StepForm = step;
exports.TabDrawer = index$4;
exports.Table = Table;
exports.TableProvider = TableProvider;
exports.tools = tools;
exports.useCreatePage = useCreatePage;
