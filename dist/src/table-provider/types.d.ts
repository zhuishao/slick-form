...
export interface TableProviderProps {
    ...
    onQuery?: (params?: any, filter?: any, sorter?: any) => void;
    /** 加载完毕回调 */
    onLoad?: (list: any, extOptions: object) => void;
    /** 表头按钮点击回调 */
    toolsClick?: (tool: any, api?: {
        onSearch: (params?: any) => {};
    }) => void;
    /** 表格列点击事件回调 */
    rowOperationsClick?: (menu: any, record: any, index: number, api?: {
        onSearch: (params?: any) => {};
...
export interface SearchProps extends Omit<FormLibProps, 'onReset'> {
    ...
    onReset?: (clearInitialValuesOnReset?: any) => void;
...
export interface ToolsProps {
    ...
    modalFormProps?: CreateModalFormProps | (({ onSearch, onRefresh, selectedRows, }: {
        onSearch: any;
        onRefresh: any;
        selectedRows: any;
    }) => CreateModalFormProps | Promise<CreateModalFormProps>);
    drawerFormProps?: CreateDrawerFormProps | (({ onSearch, onRefresh, selectedRows, }: {
        onSearch: any;
        onRefresh: any;
        selectedRows: any;
...
export interface TableProps<T = any> extends Omit<AntdTableProps<T>, 'pagination' | 'title' | 'columns' | 'rowSelection'> {
    title?: ReactNode;
    columns: TableColumnType<T>[];
    /** 处理请求逻辑3个参数分别为、查询条件、过滤条件、排序条件 */
    request: (params?: any, filter?: any, sorter?: any) => Promise<TableResponse>;
    tools?: ToolsProps[];
    ...
    infoContent?: React.ReactNode | ((selectedRowKeys: any, selectedRows: any, onCleanSelected: any) => ReactNode);
