...
/** FormItemProps */
export interface FormFieldProps<T = FieldProps> extends Omit<FormItemProps, 'required'> {
    key?: string | number;
...
export declare type FieldProps = InputProps | PasswordProps | SearchProps | GroupProps | TextAreaProps | InputNumberProps | AutoCompleteProps | UploadProps | SwitchProps | CascaderProps<any> | RateProps | SliderSingleProps | AsyncSelectProps | RadioProps | RadioGroupProps | CheckboxProps | DatePickerProps | TimePickerProps | TimeRangePickerProps | TreeSelectProps<any> | ExtensionProps;
/** 添加扩展属性 */
