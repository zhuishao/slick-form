...
export interface FormLibInstance {
    ...
    /** 更新指定表单项的配置，重新渲染该组件 */
    mergeFieldByName: (names: string, newField: FormFieldProps, customizer?: Function) => void;
    /** 获取指定的field */
    ...
    getFieldsValue: (nameList?: string[] | true, filterFunc?: (meta: any) => boolean) => any;
...
declare const Hello: React.FC<FormLibInstance>;
