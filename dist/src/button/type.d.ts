...
export declare type ConfirmProps = PopconfirmProps & {
    type?: 'pop' | 'alert';
...
export interface ProButtonComponent extends React.ForwardRefExoticComponent<ProBtnProps & React.RefAttributes<HTMLButtonElement>> {
    setAuth?: (auths: any) => void;
    getAuth?: () => any;
    hasAuth?: (authKey: string) => boolean;
}
declare const Hello: React.FC<ProBtnProps>;
